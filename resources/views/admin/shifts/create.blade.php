...
<div class="page-header">
    <h5>Tambah Shift Baru</h5>
    <p>Buat jadwal shift karyawan</p>
</div>

<div class="card">
    <div class="card-header">
        <span style="font-size: 14px; font-weight: 600;">Form Tambah Shift</span>
    </div>
    <div class="card-body p-4">
        <form method="POST" action="{{ route('admin.shifts.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="notes" class="form-control" rows="3"
                              placeholder="Catatan shift (opsional)">{{ old('notes') }}</textarea>
                </div>
            </div>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-dark px-4">Simpan Shift</button>
